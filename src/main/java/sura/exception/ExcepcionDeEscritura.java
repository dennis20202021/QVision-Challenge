...
/*
 * @(#) ExcepcionDeEscritura.java 1.0 15/04/2025
 *
 * Copyright 2024 Sura Afore, Inc. Todos los derechos reservados.
 */

/**
 * La clase {@code ExcepcionDeEscritura} es heredada de {@code RuntimeException} y representa una excepción personalizada
 * que se lanza cuando ocurre un error al intentar escribir en el sistema de archivos.
 *
 * <p>
 * Esta clase permite:
 * <ul>
 ...
 * Ejemplo de uso:
 * <pre>{@code
 * throw new ExcepcionDeEscritura("Error de permisos", Data.class.getName(), "No se puede escribir en el archivo");
 * }</pre>
 * </p>
 *
 * <p>
...
public class ExcepcionDeEscritura extends RuntimeException implements Serializable {
    ...
    /*
     * @ExcepcionDeEscritura
     *
     * Copyright 2024 Sura Afore Inc. Todos los derechos reservados.
     */

    /**
     * Constructor para la clase {@code ExcepcionDeEscritura}.
     *
